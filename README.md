...
# sails-generate-controller-coffee


A `controller.coffee` generator for use with the Sails command-line interface.
...
```json
{
	"generators": {
		"modules": {
			"controller": "sails-generate-controller-coffee"
		}
	}
}
```
...
**[MIT](./LICENSE)**
&copy; 2014 [nyamadori](http://github.com/nyamadori)
